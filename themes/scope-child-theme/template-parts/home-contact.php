        ...
        <div class="row">
          <div class="col-md-6">
            <div class="other-contact-info">
              <div class="contact-info-block">
                <h3 class="contact-info-location-label">
                  <?php echo esc_html(get_theme_mod('themefarmer_home_contact_location_label')); ?></h3>
              ...
              <div class="contact-info-block">
                <h3 class="contact-info-location-label">
                  <?php echo esc_html(get_theme_mod('themefarmer_home_contact_us_label')); ?></h3>
                <div class="contact-info-location-details">
          ...
          <div class="col-md-6">
            <div class="scope-contact-form">
              <h3 class="form-title"><?php echo esc_html(get_theme_mod('themefarmer_home_contact_form_heading')); ?>
              </h3>
              <?php
