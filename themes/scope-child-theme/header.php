...
$frontpage = is_front_page() ? 'isfront' : null;
$site_header = is_front_page() ? 'site-header' : 'not-frontpage-header';
...
<body <?php body_class(); ?>>
  <div id="page" class="wrapper site">
    ...
    <!-- header-transparent  -->
    <header id="masthead"
      class="<?php echo $site_header ?> <?php echo esc_attr($heaer_class); ?> <?php echo $frontpage; ?>">
          ...
          <div class="primary-menu-container">
            <nav id="site-navigation" class="main-navigation navbar navbar-expand-md navbar-light row"
              ...
              <div class="navbar-header col-md-3">
                ...
                <button class="navbar-toggler invisible" type="button" data-toggle="collapse"
                  data-target="#site-header-cart" aria-controls="site-header-cart" aria-expanded="false"
                  aria-label="<?php esc_attr_e('Toggle cart', 'scope'); ?>">
                  <?php if (scope_is_wc()) {
                    scope_woocommerce_cart_link_contnet();
                  } ?>
                </button>
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#TF-Navbar"
                  aria-controls="TF-Navbar" aria-expanded="false"
                  aria-label="<?php esc_attr_e('Toggle navigation', 'scope'); ?>">
              ...
              <?php
              if (scope_is_wc()) {
                echo scope_woocommerce_header_cart();
              }
              wp_nav_menu(array(
