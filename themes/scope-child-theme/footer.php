    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-6 footer-copy text-center">
          <p>&copy; <?php echo esc_html(date_i18n(__('Y', 'scope'))) . ' ';
                    bloginfo('name'); ?> |
            <?php printf(esc_html__('Theme: %1$s', 'scope'),  '<a href="' . esc_url('https://www.themefarmer.com/scope/') . '" rel="designer">Scope</a>'); ?>
          </p>
        </div>
      </div>
    </div>
