	...
	class Builtin {
		...
		function set_predefined_fields() {
			...
			$profile_privacy = apply_filters( 'um_profile_privacy_options', array(
				'Everyone'  => __( 'Alla', 'ultimate-member' ),
				'Only me'   => __( 'Bara jag', 'ultimate-member' )
			) );
			...
			$this->predefined_fields = array(
				...
				'user_login' => array(
					...
					'metakey' => 'user_login',
					'type' => 'text',
					'label' => __('Användarnamn','ultimate-member'),
					'required' => 1,
					'public' => 1,
					'editable' => 0,
				...
				'first_name' => array(
					...
					'metakey' => 'first_name',
					'type' => 'text',
					'label' => __('Förnamn','ultimate-member'),
					'required' => 0,
					'public' => 1,
					'editable' => 1,
				),
				...
				'last_name' => array(
					...
					'metakey' => 'last_name',
					'type' => 'text',
					'label' => __('Efternamn','ultimate-member'),
					'required' => 0,
					'public' => 1,
					'editable' => 1,
				),
				...
				'user_email' => array(
					...
					'metakey' => 'user_email',
					'type' => 'text',
					'label' => __('E-postadress','ultimate-member'),
					'required' => 0,
					'public' => 1,
				...
				'profile_photo' => array(
					...
					'type' => 'image',
					'label' => __('Ändra ditt profilfoto','ultimate-member'),
					'upload_text' => __('Ladda upp ditt foto här','ultimate-member'),
				...
				'cover_photo' => array(
					...
					'metakey' => 'cover_photo',
					'type' => 'image',
					'label' => __('Ändra ditt omslagsfoto','ultimate-member'),
					'upload_text' => __('Ladda upp profilomslaget här','ultimate-member'),
				...
				'username_b' => array(
					...
					'metakey' => 'username_b',
					'type' => 'text',
					'placeholder' => __('Ange ditt användarnamn eller e-postadress','ultimate-member'),
					'required' => 1,
					'public' => 1,
					'editable' => 0,
					'private_use' => true,
				...
				'profile_privacy'       => array(
					...
					'type'          => 'select',
					'label'         => __( 'Profil Sekretess', 'ultimate-member' ),
					'help'          => __( 'Vem kan se din offentliga profil?', 'ultimate-member' ),
					'required'      => 0,
					'public'        => 1,
					'editable'      => 1,
					'default'       => 'Everyone',
				...
				'profile_noindex'       => array(
					...
					'type'          => 'select',
					'label'         => __( 'Undvik att indexera min profil av sökmotorer', 'ultimate-member' ),
					'help'          => __( 'Göm min profil för robotar?', 'ultimate-member' ),
					'required'      => 0,
					'public'        => 1,
					'editable'      => 1,
					'default'       => UM()->roles()->um_user_can( 'profile_noindex' ) ? '1' : '0',
					'options'       => array(
						'0'     => __( 'Nej', 'ultimate-member' ),
						'1'     => __( 'Ja', 'ultimate-member' ),
					),
					'allowclear'    => 0,
					'account_only'  => true,
					'required_perm' => 'can_make_private_profile',
				...
				'hide_in_members'       => array(
					...
					'type'          => 'radio',
					'label'         => __( 'Dölj min profil från katalogen', 'ultimate-member' ),
					'help'          => __( 'Här kan du dölja dig från att visas i offentlig katalog', 'ultimate-member' ),
					'required'      => 0,
					'public'        => 1,
					'editable'      => 1,
					'default'       => UM()->member_directory()->get_hide_in_members_default() ? 'Yes' : 'No',
					'options'       => array(
						'No'    => __( 'Nej', 'ultimate-member' ),
						'Yes'   => __( 'Ja', 'ultimate-member' ),
					),
					'account_only'  => true,
				...
				'single_user_password'  => array(
					...
					'type'          => 'password',
					'label'         => __( 'Lösenord', 'ultimate-member' ),
					'required'      => 1,
					'public'        => 1,
					'editable'      => 1,
					'account_only'  => true,
