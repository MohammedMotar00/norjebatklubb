...
function um_submit_form_errors_hook_login( $args ) {
	...
	if ( isset( $args['username'] ) && $args['username'] == '' ) {
		UM()->form()->add_error( 'username', __( 'Vänligen ange ditt användarnamn eller e-postadress', 'ultimate-member' ) );
	}
	...
	if ( $args['user_password'] == '' ) {
		UM()->form()->add_error( 'user_password', __( 'Vänligen ange ditt lösenord', 'ultimate-member' ) );
	}
	...
	if ( $user && wp_check_password( $args['user_password'], $user->data->user_pass, $user->ID ) ) {
		...
		UM()->form()->add_error( 'user_password', __( 'Lösenord är inkorrekt. Var god försök igen.', 'ultimate-member' ) );
	}
...
function um_add_submit_button_to_login( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php if ( isset( $args['show_rememberme'] ) && $args['show_rememberme'] ) {
			UM()->fields()->checkbox( 'rememberme', __( 'Håll mig inloggad', 'ultimate-member' ), false ); ?>
...
function um_after_login_submit( $args ) {
	...
	<div class="um-col-alt-b">
		<a href="<?php echo esc_url( um_get_core_page( 'password-reset' ) ); ?>" class="um-link-alt">
			<?php _e( 'Glömt ditt lösenord?', 'ultimate-member' ); ?>
		</a>
	</div>
