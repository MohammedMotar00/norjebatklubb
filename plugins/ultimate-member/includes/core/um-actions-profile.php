	...
	if ( isset( $args['cover_enabled'] ) && $args['cover_enabled'] == 1 ) {
		...
		$overlay = '<span class="um-cover-overlay">
				<span class="um-cover-overlay-s">
					<ins>
						...
						<span class="um-cover-overlay-t">' . __( 'Ändra ditt omslagsfoto', 'ultimate-member' ) . '</span>
					</ins>
				</span>
			</span>';
		...
		<div class="um-cover <?php if ( um_user( 'cover_photo' ) || ( $default_cover && $default_cover['url'] ) ) echo 'has-cover'; ?>"
			...
			if ( UM()->fields()->editing ) {
				...
				$text = ! um_user( 'cover_photo' ) ? __( 'Upload a cover photo', 'ultimate-member' ) : __( 'Ändra omslagsfoto', 'ultimate-member' ) ;

				$items = array(
					'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-cover" data-child=".um-btn-auto-width">' . $text . '</a>',
					'<a href="javascript:void(0);" class="um-reset-cover-photo" data-user_id="' . um_profile_id() . '" ' . $hide_remove . '>' . __( 'Ta bort', 'ultimate-member' ) . '</a>',
					'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'Avbryt', 'ultimate-member' ) . '</a>',
				);
				...
				if ( ! isset( UM()->user()->cannot_edit ) && ! um_user( 'cover_photo' ) ) {
					...
					$items = array(
						'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-cover" data-child=".um-btn-auto-width">' . __( 'Ladda upp ett omslagsfoto', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'Avbryt', 'ultimate-member' ) . '</a>',
					);
				...
				<?php if ( um_user( 'cover_photo' ) ) {
					...
					if ( ! isset( UM()->user()->cannot_edit ) ) { ?>
						...
						<a href="javascript:void(0);" class="um-cover-add"><span class="um-cover-add-i"><i
									...
									title="<?php esc_attr_e( 'Ladda upp ett omslagsfoto', 'ultimate-member' ); ?>"></i></span></a>
		...
		<div class="um-profile-photo" data-user_id="<?php echo esc_attr( um_profile_id() ); ?>">
			...
			<?php if ( empty( $disable_photo_uploader ) && empty( UM()->user()->cannot_edit ) ) {
				...
				if ( ! um_profile( 'profile_photo' ) ) { // has profile photo
					...
					$items = array(
						'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-profile-photo" data-child=".um-btn-auto-width">' . __( 'Ladda upp foto', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'Avbryt', 'ultimate-member' ) . '</a>',
					);
					...
					$items = array(
						'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-profile-photo" data-child=".um-btn-auto-width">' . __( 'Ändra foto', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-reset-profile-photo" data-user_id="' . esc_attr( um_profile_id() ) . '" data-default_src="' . esc_url( um_get_default_avatar_uri() ) . '">' . __( 'Ta bort foto', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'Avbryt', 'ultimate-member' ) . '</a>',
					);
			...
			<?php } elseif ( UM()->fields()->editing == true && $args['show_bio'] ) { ?>
				...
				<div class="um-meta-text">
					<textarea id="um-meta-bio"
							  ...
							  placeholder="<?php esc_attr_e( 'Berätta lite om dig själv...', 'ultimate-member' ); ?>"
...
function um_add_edit_icon( $args ) {
	...
	if ( ! um_is_myprofile() ) {
		...
		*/
		...
		$items = array(
			'editprofile' => '<a href="' . esc_url( um_edit_profile_url() ) . '" class="real_url">' . __( 'Redigera profil', 'ultimate-member' ) . '</a>',
			'myaccount'   => '<a href="' . esc_url( um_get_core_page( 'account' ) ) . '" class="real_url">' . __( 'Mitt konto', 'ultimate-member' ) . '</a>',
			'logout'      => '<a href="' . esc_url( um_get_core_page( 'logout' ) ) . '" class="real_url">' . __( 'Logga ut', 'ultimate-member' ) . '</a>',
			'cancel'      => '<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'Avbryt', 'ultimate-member' ) . '</a>',
		);
...
function um_add_submit_button_to_profile( $args ) {
	...
	<div class="um-col-alt">
        ...
        <input type="submit" value="Uppdatera profil" class="um-button" />
			</div>
