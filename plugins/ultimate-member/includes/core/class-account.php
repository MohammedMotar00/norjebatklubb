	...
	class Account {
		...
		function get_tabs() {
			...
			$tabs[100]['general'] = array(
				'icon'          => 'um-faicon-user',
				'title'         => __( 'Konto', 'ultimate-member' ),
				'submit_title'  => __( 'Uppdatera konto', 'ultimate-member' ),
			);

			$tabs[200]['password'] = array(
				'icon'          => 'um-faicon-asterisk',
				'title'         => __( 'Ändra lösenord', 'ultimate-member' ),
				'submit_title'  => __( 'Uppdatera lösenord', 'ultimate-member' ),
			);

			$tabs[300]['privacy'] = array(
				'icon'          => 'um-faicon-lock',
				'title'         => __( 'Sekretess', 'ultimate-member' ),
				'submit_title'  => __( 'Uppdatera sekretess', 'ultimate-member' ),
			);
			...
			if ( um_user( 'can_delete_profile' ) || um_user( 'can_delete_everyone' ) ) {
				...
				$tabs[99999]['delete'] = array(
					...
					'title'         => __( 'Radera konto', 'ultimate-member' ),
					'submit_title'  => __( 'Radera konto', 'ultimate-member' ),
				);
