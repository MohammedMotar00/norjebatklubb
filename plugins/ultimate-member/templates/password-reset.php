				...
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<?php _e( 'Vi har skickat en länk till återställning av lösenord till din e-post. Kontrollera din inkorg.', 'ultimate-member' ); ?>
						</div>
					</div>
				</div>
			<?php } else { ?>
				...
				<?php } else { ?>
					<div class="um-field um-field-block um-field-type_block">
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php _e( 'För att återställa ditt lösenord, ange din e-postadress eller ditt användarnamn nedan', 'ultimate-member' ); ?>
							</div>
						</div>
					</div>
				<?php }
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						<input type="submit" value="<?php esc_attr_e( 'Återställ mitt lösenord', 'ultimate-member' ); ?>" class="um-button" id="um-submit-btn" />
					</div>
